...
pde_points = init_collocation_points(xyt, num_points=int(1e6), t_max=tmax, t_min=tmin)
...
u_nn = Net(num_hidden_units=32, num_hidden_layers=4, inputs=3, inputnormalization=inputnormalization).to(device)
